...
public class CnSControlAlgorithmOCGExpertOptionsPanel extends CnSPanel {
	...
	public void initGraphics() {
		super.initGraphics();
		addComponent(new JLabel("Initial clusters"), 0, 0, 2, 1, 1.0, 0.0, NORTHWEST, HORIZONTAL, -15, 5, 5, 5, 0, 0);
		...
		addComponent(initialClustersComboBox, 0, 1, 2, 1, 1.0, 0.0, NORTHWEST, HORIZONTAL, 0, 5, 5, 5, 0, 0);
		addComponent(new JLabel("Class system"), 0, 2, 2, 1, 1.0, 0.0, NORTHWEST, HORIZONTAL, 10, 5, 5, 5, 0, 0);
		...
		addComponent(classSystemComboBox, 0, 3, 2, 1, 1.0, 0.0, WEST, HORIZONTAL, 0, 5, 5, 5, 0, 0);
		addComponent(new JLabel("Cluster max. cardinal"), 0, 4, 1, 1, 1.0, 0.0, WEST, BOTH, 10, 5, 5, 0, 0, 0);
		maxCardinalTextField = new JTextField("0");
		maxCardinalTextField.setColumns(4);
		addComponent(maxCardinalTextField, 1, 4, 1, 1, 0.0, 0.0, WEST, BOTH, 10, 5, 5, 5, 0, 0);
		addComponent(new JLabel("Cluster min. number"), 0, 5, 1, 1, 1.0, 0.0, WEST, BOTH, 0, 5, -5, 0, 0, 0);
		minNumberTextField = new JTextField("2");
		minNumberTextField.setColumns(4);
		addComponent(minNumberTextField, 1, 5, 1, 1, 0.0, 0.0, WEST, BOTH, 0, 5, -5, 5, 0, 0);
	}

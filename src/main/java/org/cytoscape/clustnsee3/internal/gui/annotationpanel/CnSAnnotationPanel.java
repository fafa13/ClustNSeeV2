...
package org.cytoscape.clustnsee3.internal.gui.annotationpanel;
...
import org.cytoscape.clustnsee3.internal.gui.annotationpanel.annotationtable.CnSAnnotationTablePanel;
import org.cytoscape.clustnsee3.internal.gui.annotationpanel.partitiontable.CnSPartitionTablePanel;
 ...
 * 
 */
public class CnSAnnotationPanel extends CnSPanel implements CytoPanelComponent, CnSEventListener {
	private static final long serialVersionUID = -3877080938361953871L;
	private static CnSAnnotationPanel instance;
	...
	public static CnSAnnotationPanel getInstance() {
		if (instance == null) {
			instance = new CnSAnnotationPanel("Annotation");
	...
	private CnSAnnotationPanel(String title) {
		super(title);
		initGraphics();
		initListeners();
	}
